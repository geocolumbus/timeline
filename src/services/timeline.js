...
const keywordAndSearch = function (keywordString) {

    let selector = "(?i)"
    const keywords = keywordString.split(" ")
    for (let i = 0; i < keywords.length; i++) {
        selector += `(?=.*\\b${keywords[i]}\\b)`
    }
...
const keywordOrSearch = function (keywordString) {
